...
class RetrieveAddresses
  ...
  HEADING_HASH = {location_id: 'Location ID', name: 'Name'}
...
address_updater = RetrieveAddresses.new( ["/Users/manojsv/Desktop/averitt_retrieve.csv", [] ])
address_updater = RetrieveAddresses.new( ["/home/ec2-user/manojsv/trac_5887.csv", all_addresses ])
